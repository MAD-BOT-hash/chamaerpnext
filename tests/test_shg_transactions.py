...
class TestSHGTransactions(unittest.TestCase):
    def setUp(self):
    ...
    def test_shg_contribution_journal_entry_flow(self):
        ...
        # Verify no reference_type or reference_name is used (ERPNext v15 compliance)
        for entry in je.accounts:
    ...
    def test_shg_loan_disbursement_journal_entry_flow(self):
        ...
        # The debit should be to loan asset account and credit to bank account
    ...
    def test_shg_loan_repayment_journal_entry_flow(self):
        ...
        # Check accounts - should have debit to Bank/Cash and credits to Loan, Interest
        debit_entry = None
        ...
        # Verify custom field linking
        self.assertEqual(je.custom_shg_loan_repayment, repayment.name, 
                        "Journal Entry should be linked to the SHG Loan Repayment")
    ...
    def test_shg_meeting_fine_journal_entry_flow(self):
    ...
    def test_erpnext_v15_compliance(self):
